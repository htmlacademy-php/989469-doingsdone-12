        ...
        <div class="content">
            ...
            <main class="content__main">
                ...
                <table class="tasks">
                    ...
                    <?php if ($task['done'] === 'true' && $show_complete_tasks === 0): continue; endif; ?>
                    <tr class="tasks__item task<?php if($task['done'] === 'true'): ?> task--completed<?php endif; ?>">
                        <td class="task__select">
                            <label class="checkbox task__checkbox">
                                <input class="checkbox__input visually-hidden task__checkbox" type="checkbox" value="1" <?php if ($task['done'] === 'true'): ;?>checked<?php endif; ?> >
